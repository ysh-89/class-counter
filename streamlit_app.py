...
st.sidebar.info("💡 사이드바의 필터를 조절하면 지도의 마커가 즉시 업데이트됩니다.")
...
with tab_user:
    ...
    st.write("사이드바에서 **지역과 카테고리**를 설정할 수 있으며, 지도 위의 **카페 마커를 누르면 해당 카페의 실시간 인원수**가 집계됩니다.")
