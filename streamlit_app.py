...
# ==========================================
st.set_page_config(
    page_title="제주 실시간 카페/장소 인원 카운터",
    page_icon="☕",
    layout="wide"
)
...
st.sidebar.caption(f"📁 현재 적용 데이터: `{global_store['loaded_file']}`")
...
with tab_user:
    ...
    st.write("사이드바에서 **지역과 카테고리**를 설정할 수 있으며, 지도 상의 **마커를 클릭하면 해당 장소의 실시간 인원수**가 집계됩니다.")
